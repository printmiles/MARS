 ...
 * Created:    19-Mar-2008 21:40:00
 * Modified:   09-Jun-2008
 * Version History:
 * ~ ~ ~ ~ ~ ~ ~ ~ ~
 * 0.003a 09-Jun-2008 Copied from Mars original and changed to Deimos naming
...
/**
 * This class is used initially by the <code>RunDeimos</code> class. It assumes that
...
public class NewSplashScreen
{
  ...
  public NewSplashScreen(int maximumValue, Locale locMe)
  {
    ...
    Logger log = LoggerFactory.getLogger("mars.deimos.gui.NewSplashScreen");
    DeimosResourceBundle drbSplash = new DeimosResourceBundle(locMe);
    textVal = drbSplash.getRBString("deimos.gui.splash.load", "Loading...");
    ...
    if (splash == null)
    {
      ...
      System.err.println(drbSplash.getRBString("deimos.errors.SplashScreenNotCompatible","Splash screen is null. May be running on JSE 1.5 or earlier."));
      configured = false;
      return;
    }
    ...
    if (g == null)
    {
      ...
      System.err.println(drbSplash.getRBString("deimos.errors.Graphics2DNotFound", "Cannot obtain the Splash screen graphics2D class. It is currently null."));
      configured = false;
      return;
    }
  }
